...
export const codeExamples: Record<string, string> = {
  ...
  guess: `# لعبة تخمين الرقم\n\nاستورد العشوائي\nالعشوائي.البذرة(7)\nالهدف = صحيح(العشوائي.منتظم(1, 21))\nالمحاولات = 0\nاطبع("خمن الرقم من 1 إلى 20!")\nبينما صح:\n\tتخمين = صحيح(ادخل("تخمينك: "))\n\tالمحاولات += 1\n\tاذا تخمين == الهدف:\n\t\tاطبع(م"صح! بعد {المحاولات} محاولات")\n\t\tتوقف\n\tاواذا تخمين < الهدف:\n\t\tاطبع("أكبر!")\n\tوالا:\n\t\tاطبع("أصغر!")`,
  calc: `# الآلة الحاسبة\n\nاطبع("--- الآلة الحاسبة ---")\nأ = عشري(ادخل("العدد الأول: "))\nعملية = ادخل("العملية (+ - * \\): ")\nب = عشري(ادخل("العدد الثاني: "))\nاذا عملية == "+":\n\tالنتيجة = أ + ب\nاواذا عملية == "-":\n\tالنتيجة = أ - ب\nاواذا عملية == "*":\n\tالنتيجة = أ * ب\nاواذا عملية == "\\\\":\n\tاذا ب == 0:\n\t\tالنتيجة = "خطأ: قسمة على صفر"\n\tوالا:\n\t\tالنتيجة = أ \\ ب\nوالا:\n\tالنتيجة = "عملية مجهولة"\nاطبع(م"النتيجة: {النتيجة}")`,
  files: `# التعامل مع الملفات\n\nس = افتح("تجربة.الف", "ك")\nس.اكتب("مجتمع ألف")\nس.اغلق()\nس = افتح("تجربة.الف", "ق")\nاطبع(س.اقرا())\nس.اغلق()`,
  sets: `# المميزة (مجموعة بلا تكرار)\n\nص = {5, 9, 9, 7, 3}\nاطبع(ص)\nص.اضف(6)\nاطبع(ص)\nص.اسحب()\nاطبع(ص)`,
  lambda: `# الدالة الخطية والمعاملات المفتاحية\n\nس = خطية س: س*3\nاطبع(س(99))\n\nدالة تجربة(س, ليمون = "10"):\n\tاطبع(س)\n\tاطبع(ليمون)\nتجربة(3, ليمون = "7")`,
  blank: ``
};
